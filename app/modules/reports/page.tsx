...
import { FileTextIcon, LockIcon, CheckIcon } from "@/components/ui/icons"
      ...
      <div className="container mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center mb-12">
          ...
          <Badge variant="outline" className="mb-4">
            Requiere plan Advanced o superior
          </Badge>
          <h1 className="text-4xl font-bold text-gray-900 mb-4">Reportes Premium</h1>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Genera informes ejecutivos profesionales con exportación avanzada
          </p>
        </div>
        ...
        <div className="bg-gradient-to-br from-primary/10 to-primary/5 rounded-2xl p-8 text-center">
          <h2 className="text-2xl font-bold text-gray-900 mb-2">Reportes de nivel empresarial</h2>
          <p className="text-gray-600 mb-6">Actualiza a un plan Advanced o superior para acceder a este módulo</p>
