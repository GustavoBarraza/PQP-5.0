...
export default function ComplianceModulePage() {
  ...
  const features = [
    ...
    "Gestión de normativas y regulaciones",
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl font-bold text-gray-900 mb-4">Cumplimiento</h1>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Gestiona auditorías, normativas y riesgos de manera eficiente
          </p>
        </div>
        ...
        <div className="bg-gradient-to-br from-primary/10 to-primary/5 rounded-2xl p-8 text-center">
          <h2 className="text-2xl font-bold text-gray-900 mb-2">Asegura el cumplimiento normativo</h2>
