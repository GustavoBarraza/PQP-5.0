  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b bg-white">
      ...
      <div className="hidden lg:block w-full bg-gray-50 border-b">
        <div className="container mx-auto flex justify-end items-center h-9 px-4 text-sm text-gray-700 gap-4">
          <button
      ...
      {/* 🔹 BARRA PRINCIPAL */}
      <div className="flex items-center justify-between h-20 lg:h-24 px-4 lg:px-10">
        {/* Logo */}
        <Link href="/" className="flex items-center gap-2 z-10">
          <img
            src="/Logo-completo-PQP5.0.webp"
            alt="Logo PQP"
